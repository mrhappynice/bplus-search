# bplus🤷🏻‍♂️ Search 
NO LONGER MAINTAINING THIS VERSION. MOVED TO RUST. check out [bplus-searchrs](https://github.com/mrhappynice/bplus-searchrs) for current version and better features.
